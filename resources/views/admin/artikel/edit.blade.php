            ...
            <div class="col-12">
                ...
                <form action="{{ route('article.update', $article->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{ old('title', $article->title) }}" name="title" class="form-control" id="title" placeholder="Nama Merch" required autofocus>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" value="{{ old('category', $article->category) }}" name="category" class="form-control" id="category" placeholder="Kategori Merch" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="review" class="form-control" id="review" rows="3">{{ old('review', $article->review) }}</textarea>
